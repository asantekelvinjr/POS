                ...
                <tr key={product.id} className="hover:bg-surface-2 transition-pos">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-9 h-9 rounded-pos-md flex items-center justify-center font-bold text-sm shrink-0"
                  ...
                  <td className="px-6 py-4 font-semibold text-primary">GHS {product.price.toFixed(2)}</td>
                  <td className="px-6 py-4 text-secondary">
                    {product.costPrice ? `GHS ${product.costPrice.toFixed(2)}` : '—'}
                  </td>
                  <td className="px-6 py-4">
                    <Badge
                      variant={
